...
void main() async {
  ...
  try {
    ...
    final empleadosExistentes = await connection.execute(
    ...
    final semanasActivas = await connection.execute(
    ...
    final cuadrillas = await connection.execute(
    ...
    final empleados = await connection.execute(
    ...
    if (cuadrillas.isNotEmpty && empleados.isNotEmpty) {
      ...
      try {
        ...
        final existeRegistro = await connection.execute(
