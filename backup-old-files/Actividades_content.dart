...
class _ActividadesContentState extends State<ActividadesContent> {
  ...
  List<List<String>> get actividadesFiltradas {
    ...
    if (cuadrillaSeleccionada != null && cuadrillaSeleccionada != 'Todas las cuadrillas') {
                                    ...
                                    children: [
                                      Wrap(
                                        ...
                                        children: [
                                          ...
                                          CustomDropdownField<String>(
                                            label: 'Cuadrilla',
                                            value: cuadrillaSeleccionada == 'Todas las cuadrillas' 
                                                ? null 
                                                : cuadrillaSeleccionada,
                                            items: cuadrillas
                                                .where((c) => c['nombre'] != 'Todas las cuadrillas')
                                                .map((c) => c['nombre']!)
                                                .toList(),
                                            itemLabel: (item) => item,
                                            onChanged: (value) {
                              ...
                              if (cuadrillaSeleccionada != 'Todas las cuadrillas') ...[
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(color: Color(0xFF0B7A2F), width: 1),
                                  ),
                                  child: Row(
